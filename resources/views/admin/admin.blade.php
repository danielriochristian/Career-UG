        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/admin" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Manage Admin</a>
                    </li>
                    <li>
                        <a href="/roles" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Manage Roles</a>
                    </li>
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-desktop fa-fw"></i> <span class="hide-menu"> Website <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="#"><i class="fa-fw">P</i><span class="hide-menu">Manage Menu</span></a> </li>
                            <li> <a href="#"><i class="fa-fw">PO</i><span class="hide-menu">Product Orders</span></a> </li>
                            <li> <a href="#"><i class="fa-fw">PD</i><span class="hide-menu">Product Details</span></a> </li>
                        </ul>
                    </li>
                </ul>
            </div>
