<div class="shadow-sm p-3 mb-5 bg-white navbar navbar-expand-md navbar-light fixed-top bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
            <button class="btn btn-outline-success mx-3" data-toggle="modal"  data-target="#exampleModal" type="button"> <i class="fa fa-user" style="margin-right: 10px;"> </i>LOGIN</button>
      <div class="dropdown">
        <button class="btn btn-outline-success dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="far fa-edit" style="margin-right: 10px;"> </i>REGISTRATION
        </button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="/seeker" style="color:#008000"><i class="fa fa-user" style="margin-right: 10px;color:#008000 ;"></i>Job Seeker</a>
          <a class="dropdown-item" href="/employer" style="color:#008000"><i class="fas fa-users" style="margin-right: 10px;color:#008000;"></i>Employer</a>
        </div>
      </div>
    </form>
  </div>
