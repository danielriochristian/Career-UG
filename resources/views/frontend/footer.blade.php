...
<!-- footer -->
<div class="container-xl-2">
<div style="width:60%; height: 3px; background-color:#8A2BE2;"><div style="width:35%; height: 3px; background-color:#FF8C00;margin-left:100%"><div style="width:90%; height: 3px; background-color:#FFD700;margin-left:100%"></div></div>
</div>
</div>
<div class="container-xl-2" style="background-color:#000000">
  <div class="col-md-auto" style="margin-left:35%">
    <div class="row" style="width:100%">
      <div class="col-md-auto">
        <img src="{{url('assets/dist/img/Logo_FOOTER.png')}}" class="rounded" align="right" style="margin-top:15%"></a>
      </div>
      <div class="col-md-auto" style="margin-left:-1%">
